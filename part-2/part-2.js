...
function task1() {
  ...
  return result; //  Price { fee: 45, premium: 300 }
}
...
function task2() {
  ...
  return result; // { fee: 30, premium: 315 }
}

console.log(task2());


module.exports = { // added because  `npm run part2test` would otherwise give "TypeError: task1 is not a function"
  task1,
  task2
  };